...
- 小马智行与广汽商用车展示基于 T9 纯电平台的新一代自动驾驶重卡，量产安排仍属于年内计划。产品发布、规模交付和实际经营效果应分别判断。[9 月 14 日公告](https://ir.pony.ai/zh-hant/news-releases/news-release-details/pony-ai-inc-unveils-new-gen-4-robotruck-collaboration-gac)
- Coforge 宣布 9 月 15—16 日举行 TechCon 2026，以培训、实践和伙伴协作推动企业 AI 应用；参与活动不能直接证明岗位能力已经提升。[公司公告](https://news.coforge.com/newsroom/press-release/coforge-global-event-advances-workforce-readiness-for-enterprise-ai-adoption)
- Eurostat 的新文章回顾 2025 年成人学习参与情况。这是历史统计的专题发布，并非 2026 年 9 月即时调查，也不是 AI 专项培训统计。[官方文章](https://ec.europa.eu/eurostat/en/web/products-eurostat-news/w/ddn-20260914-1)
- 今日可操作的重点：把一个拟自动化流程的异常处理、人员练习和配套投入列清，再判断部署条件是否具备。

## AI Daily｜自动驾驶重卡：硬件降本不等于每趟运输都已降本

小马智行于 9 月 14 日 08:00 EDT 公告与广汽商用车合作的新款 L4 重卡，采用 T9 纯电平台及冗余架构，计划今年稍后量产。公司称自动驾驶套件的物料成本较上一代下降 70%，并预计吨公里运输成本下降 30%。前者是厂商披露的特定硬件口径，后者是预期效果，都不能改写成整车采购价或已验证车队利润。[官方公告检索文本](https://ir.pony.ai/zh-hant/news-releases/news-release-details/pony-ai-inc-unveils-new-gen-4-robotruck-collaboration-gac)
...
Coforge 的 9 月 14 日公告将 TechCon 2026 安排在 9 月 15—16 日，包含课程、讨论和实践展示。公司称相关 AI 黑客松吸引超过 3,000 人参与，并以其 46,000 名员工群体为活动背景。后一个数字不是已经完成培训或通过技能考核的人数；公告表达的是公司计划与参与情况，不是经独立验证的客户成效。[公司发布文本](https://news.coforge.com/newsroom/press-release/coforge-global-event-advances-workforce-readiness-for-enterprise-ai-adoption)
...
Eurostat 9 月 14 日文章给出的 2025 年欧盟成人学习参与率为 13.7%，女性为 14.9%，男性为 12.4%。这些数值描述教育与培训参与，不能解释成 AI 使用率、技能考试通过率或生产率增幅。[官方专题文章](https://ec.europa.eu/eurostat/en/web/products-eurostat-news/w/ddn-20260914-1)

指标来自劳动力调查，对象为 25—64 岁人群，考察受访前四周是否接受正规或非正规教育培训，包含与工作相关及不相关活动；分母排除未回答该问题的人。四周是调查回看窗口，2025 年是统计参考年，并非只调查了 2025 年中的某四周。元数据还提示 2021 年存在时间序列断点，因此本期不画跨断点的增长曲线。[统计定义及可比性](https://ec.europa.eu/eurostat/cache/metadata/en/sdg_04_60_esmsip2.htm)
...
Coforge 将活动安排至 9 月 16 日，因此明日可关注是否出现具体案例、可检查的方法或后续材料；这只是依据公开日程设置观察点，不预言活动结束后一定发布成果。[活动安排](https://news.coforge.com/newsroom/press-release/coforge-global-event-advances-workforce-readiness-for-enterprise-ai-adoption)
...
![2025年欧盟25至64岁人群成人学习参与率](assets/chart.svg)
...
三根柱均为同一参考年的比例，不是时间趋势，也不能相加。总体不是简单取两个比例的平均值。图表描述参与而非培训时长、内容或效果；性别差异不能由这些汇总数直接解释。[数值来源](https://ec.europa.eu/eurostat/en/web/products-eurostat-news/w/ddn-20260914-1) [指标口径](https://ec.europa.eu/eurostat/cache/metadata/en/sdg_04_60_esmsip2.htm)
...
出处：Caltech Magazine 的《Biology through the Eyes of a Physicist》记述这句话出现在费曼的黑板上。[校方文章](https://magazine.caltech.edu/post/biology-through-the-eyes-of-a-physicist)

本刊解读：把理解转成可以检验的构建，是发现遗漏的一种方法；但做出一次演示仍不等于已经理解所有条件，更不能替代正式验证。

## Action Items｜今天可以完成的小范围检查

1. 选一个准备自动化的流程，写出工具之外必须配合的条件：输入、人员、系统、时间和异常处理；找出最可能阻塞运行的一项。
2. 为一项新技能设计正常与异常两类练习，观察能否独立判断，而不只统计课程是否看完。仅使用已获授权且去敏的样本。
3. 检查一张正在使用的统计图，补齐人群、分母、参考期及“参与还是效果”的定义；删除来源没有支持的因果结论。
